# Airbnb-Data-Pipeline-Using-Snowflake-DBT-AWS

## Overview
This project implements a complete end-to-end data engineering pipeline for Airbnb data using modern cloud technologies. The solution demonstrates best practices in data warehousing, data transformation, and data analytics using Snowflake, dbt (Data Build Tool), and AWS.
